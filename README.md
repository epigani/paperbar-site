...
- The Download links point to `https://github.com/epigani/paperbar-site/releases/download/v0.1.0-beta.11/PaperBar.dmg`.
...
- The Ko-fi support link is configured in `config.js`.

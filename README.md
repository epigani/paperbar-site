...
- The Download links point to `https://github.com/epigani/paperbar-site/releases/download/v0.1.0-beta.12/PaperBar.dmg`.
...
- The Ko-fi support URL is configured in `config.js`.
